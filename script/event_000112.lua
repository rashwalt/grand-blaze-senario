...
for entry = 1, #partymember do
  if checkcomp(partymember[entry],37) == false and checkoffer(partymember[entry],37) == true and checkhaveitem(partymember[entry],3204,1) == false then
    is_event = true
  end
end
